...
class App {
  ...
  _newWorkout(e) {
    ...
    let workout;
    //2.if running create running object
    ...
    //3. if cycling create cyclying  object
    ...
    //4. add the new object to the workout array
    ...
    //6. render the workout on the list
    ...
    //8. set local storage to workouts
